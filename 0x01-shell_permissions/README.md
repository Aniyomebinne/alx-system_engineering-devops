...
6. "chmod 744" - Write a script that adds execute permission to the owner of a file.
7. "chmod 754" - Write a script that adds execute permission to the owner and the group owner, and read permission to other users, to a file.
